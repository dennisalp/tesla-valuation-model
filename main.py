...
df = {
    'date': [dt(2021,4,2), dt(2021,7,1), dt(2021,10,1), dt(2022,1,1), dt(2022,4,1), dt(2022,7,1), dt(2022,10,1), dt(2023,1,1), dt(2023,4,1)],
    # Total production
    pp[0]: [180338, 206421, 237823, 305840, 305407, 258580, 365923, 439701, 440808],
    # Operating expenses
    pp[1]: np.array([ 1.621, 1.572, 1.656,  1.894,  1.857,  1.770,  1.694, 1.876, 1.847, ])*1e9,
    # Cost of revenues - Automotive sales
    pp[2]: np.array([ 6.617, 7.307, 8.150, 10.689, 10.914, 10.153, 13.099, 15.433, 15.422])*1e9,
    # Revenues - Automotive sales
    pp[3]: np.array([ 8.705, 9.874, 11.393, 15.025, 15.514, 13.670, 17.785, 20.241, 18.878])*1e9,
    # Market cap - At end of quarter
    'mcap': np.array([650, 670, 770, 1050, 1100, 720, 800, 480, 644])*1e9
    }
